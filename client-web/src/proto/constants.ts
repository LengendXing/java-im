...
export const Cmd = {
  ...
  MSG_ACK: 0x0110,
  MSG_READ: 0x0111,
  MSG_READ_NOTIFY: 0x0112,
  MSG_RECALL: 0x0121,
  MSG_RECALL_NOTIFY: 0x0122,
  SYNC: 0x0301,
  SYNC_ACK: 0x0302,
  SESSION_LIST: 0x0401,
  ...
  FRIEND_APPLY: 0x0501,
  FRIEND_LIST: 0x0502,
  FRIEND_APPLY_NOTIFY: 0x0503,
  FRIEND_REQUEST_LIST: 0x0504,
  FRIEND_ACCEPT: 0x0511,
  FRIEND_REJECT: 0x0512,
  GROUP_CREATE: 0x0601,
  GROUP_MEMBER_LIST: 0x0602,
  GROUP_INVITE: 0x0603,
  GROUP_KICK: 0x0604,
  GROUP_DISSOLVE: 0x0605,
  KICKOFF: 0x0f01,
} as const;
